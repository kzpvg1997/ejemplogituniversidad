...
import co.edu.eam.disenosoft.universidad.vista.controladores.ControladorVerEstudiante;
...
public class DialogoVerEstudiante extends javax.swing.JDialog {
     ...
     */
	private ControladorVerEstudiante controlador;
  
	public DialogoVerEstudiante(RegistroCurso rc) {
        super();
        initComponents();
        controlador = new ControladorVerEstudiante();
        tfcedulaestudiante.setText(rc.getEstudiante().getCedula());
        tfnombreestudiante.setText(rc.getEstudiante().getNombre());
        try {
	            ...
	            for(int i=0;i<count;i++){
	        		...
	        		if(!n.isEmpty()){
						for(int j=0;j<n.size();j++){
							if(n.get(j).getEvaluacion().getId() == e.get(i).getId()){
